...
const Footer = () => {
    return (
        <div className='d-flex bg-primary list-unstyled'>
            <div className='footer w-50 p-3'>
                <h5 className='text-light'>Mart</h5>
                <li className="para text-white-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed aspernatur ea deserunt dicta rem sit iste placeat? Exercitationem sint pariatur quae officiis praesentium earum dolorem consequuntur nulla! Quae, ad ullam.</li>
            </div>
            ...
            <div className='footer w-25 p-2'>
                ...
                <li className="para text-white-50">70 Washingtons Square</li>
                <li className="para text-white-50">South New York,NY 10012.</li>
                <li className="para text-white-50">Unistad States</li>
